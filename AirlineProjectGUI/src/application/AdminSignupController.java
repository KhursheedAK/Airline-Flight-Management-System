...
public class AdminSignupController 
{
	...
	@FXML
	public ImageView singupImage = new ImageView("C:\\Users\\survi\\Desktop\\Java Codes\\AirlineProjectGUI\\src\\15.png");
	...
	public void goToRegister(ActionEvent event) throws IOException, NumberFormatException, NullPointerException
	{
		try
		{
			...
			int foo = Integer.parseInt(enter_Employee_ID_Text_Field.getText());
			int empId = foo;
			int foo2 = Integer.parseInt(enter_Age_Text_Field.getText());
			int age = foo2;
			String gender = enter_Gender_Text_Field.getText();
			
			boolean flag = airline.signupAdmin(empId, name, cnic, gender, age, password);
			...
			else
			{
				 ...
				 alert.getDialogPane().setContentText("Failed to Register!");
				 alert.showAndWait();
			}
